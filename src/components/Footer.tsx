  ...
  <footer className="bg-surface-beige mt-24">
    <div className="container mx-auto py-16 px-4">
      <div className="grid md:grid-cols-5 gap-12 mb-12">
        ...
        {[
          { title: "Produkt", links: ["Police-Check", "Vergleich", "Familien-Dashboard", "Kündigung"] },
          { title: "Unternehmen", links: ["Über uns", "Karriere", "Presse", "Blog"] },
          { title: "Rechtliches", links: ["Datenschutz", "Impressum", "AGB", "FINMA-Register"] },
        ].map((col) => (
          <div key={col.title}>
            ...
            <ul className="space-y-2.5">
              {col.links.map((l) => (
                <li key={l}>
                  <Link to="/" className="text-sm text-foreground-secondary hover:text-primary">
                    {l}
                  </Link>
                </li>
              ))}
